...
classdef FrameElement < Element2Nodes
    ...
    methods
        ...
        function states = get_solution_states(obj)
            ...
            states = [...
                sprintf("node(%s) top", obj.node_1.uuid) , obj.get_solution(0, obj.r),...
                sprintf("node(%s) bottom", obj.node_1.uuid) , obj.get_solution(0, -obj.r),...
                sprintf("node(%s) top", obj.node_2.uuid) , obj.get_solution(obj.l, obj.r),...
                sprintf("node(%s) bottom", obj.node_2.uuid) , obj.get_solution(obj.l, -obj.r),...
            ];
        end
